...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('shop/plugins/swiper/swiper-bundle.css') }}" />
    <link rel="stylesheet" href="{{ asset('shop/plugins/font-awesome/v6/brands.css') }}" />
    <link rel="stylesheet" href="{{ asset('shop/plugins/font-awesome/v6/solid.css') }}" />
    <link rel="stylesheet" href="{{ asset('shop/plugins/font-awesome/v6/fontawesome.css') }}" />
    <link href="{{ asset('shop/styles/main.css') }}" rel="stylesheet" />
</head>
<header class="header">
    <nav class="navbar container">
      ...
      <div class="order-1 ml-auto hidden items-center md:order-2 md:ml-0 lg:flex">
        <a class="btn btn-white btn-sm" href="{{ route('dashboard') }}">Sing Up Now</a>
      </div>
    </nav>
  </header>
<body>
  ...
  <!-- Swiper JS -->
  <script src="{{ asset('shop/plugins/swiper/swiper-bundle.js') }}"></script>
  <script src="{{ asset('shop/plugins/shufflejs/shuffle.js') }}"></script>

  <!-- Main Script -->
  <script src="{{ asset('shop/scripts/main.js') }}"></script>
