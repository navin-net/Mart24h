...
@section('title', $shopDetail->name . ' - ' . __('messages.home'))
...
@section('content')
    ...
    <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            @foreach ($banners as $index => $banner)
                <div class="carousel-item {{ $index == 0 ? 'active' : '' }} hero-section"
                    ...
                    <div class="container h-100 d-flex align-items-center">
                        <!-- <div class="hero-content col-md-6">
                            ...
                            <p class="lead">{{ $banner->description ?? 'Shop with style and confidence.' }}</p>
                            @if (!empty($banner->link))
                                <a href="{{ $banner->link }}" class="btn btn-primary btn-lg mt-3" target="_blank">View Now</a>
                            @endif
                        </div> -->
                    </div>
                </div>
