<aside class="sidebar">
    <div class="sidebar-user">
        <div class="d-flex align-items-center mb-3">
            <img src="{{ asset('assets/img/profile-img.jpg') }}" alt="Profile" class="rounded-circle me-2" width="40"
                height="40">
            <div>
...
<a class="nav-link d-flex align-items-center justify-content-between {{ request()->is('products*') ? 'active' : '' }}"
    data-bs-toggle="collapse" href="#shop-nav"
    aria-expanded="{{ request()->is('products*') ? 'true' : 'false' }}" aria-controls="shop-nav">
    <div>
...
<div id="shop-nav" class="collapse {{ request()->is('products*') ? 'show' : '' }} ps-4 mt-1">
    <a href="{{ url('/products') }}"
        class="nav-link d-flex align-items-center {{ request()->is('products') ? 'active' : '' }}">
    ...
    <a href="{{ url('/products/create') }}"
        ...
        <div class="mb-2">
            ...
            <div id="settings-nav"
                class="collapse {{ request()->is('brands', 'categories', 'qualitys') ? 'show' : '' }} ps-4 mt-1">
        ...
        <div class="mb-2">
            <a class="nav-link d-flex align-items-center justify-content-between {{ request()->is('slider') ? 'active' : '' }}"
                data-bs-toggle="collapse" href="#shop-nav"
                aria-expanded="{{ request()->is('slider') ? 'true' : 'false' }}" aria-controls="shop-nav">
                <div>
                    <i class="bi bi-shop"></i>
            ...
            <div id="shop-nav" class="collapse {{ request()->is('banner') ? 'show' : '' }} ps-4 mt-1">
